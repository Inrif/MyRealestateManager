...
class RMSearchFragment : RMBaseFragment(), RMAdapterListener {
    ...
    override fun onClick(v: View?) {
        ...
        // By action (Safe Args)
        val action = RMSearchFragmentDirections.actionSearchFragmentToDetailsFragment(itemId)
    ...
    private fun configureRecyclerView() {
        ...
        this.mAdapter = RMListAdapter(
            mCallback = this@RMSearchFragment
        )
        ...
        with(this.mRootView.fragment_search_RecyclerView) {
            ...
            adapter = this@RMSearchFragment.mAdapter
        }
    }
    ...
    private fun actionToSearchRealEstates() {
        ...
        this.mViewModel.getRealEstatesAndPhotosByMultiSearch(
                minPrice =
